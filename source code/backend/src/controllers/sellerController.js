...
class SellerController {
  ...
  async createSeller(req, res) {
    try {
      ...
      const subject = "IntelliMart Email Verification Code";
      const text =
        "Welcome to IntelliMart, verify your account using this link: ";
      const frontendUrl = `http://localhost:5173/verify-seller/${req.body.email}/${otp}`;
